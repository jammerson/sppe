...
$turma_hidden = array('turma' => $turma[0]->idturma);
echo form_open(base_url('prof/ensino/cadEnsino'), '', $turma_hidden);
    ...
    $data = array('name' => 'competencias', 'id' => 'form-area-maior');
    echo form_textarea($data);
    echo "<br />";
    echo form_label('Recursos Didáticos Utilizados:', 'recursos')."<br />";
    $data = array('name' => 'recursos', 'id' => 'form-area-maior');
    echo form_textarea($data);
    echo "<br />";
